            ...
            <>
                <div className="header">
                    ...
                    <div className="icons-container">  
                        <Link to={"/feed"}>
                            <House size={60} color={homeColor} weight="fill" />
                        </Link>
                        <Link to={"/friends"}>
                            <Users size={60} color={friendColor} weight="fill" />
                        </Link>
                        <Link to={"/books"}>
                            <Books size={60} color={booksColor} weight="fill" />
                        </Link>
                        <Link to={"/search"}>
                    ...
                    <div className="profile-pic">
                        <svg className='new-btn btn' onClick={() =>{
